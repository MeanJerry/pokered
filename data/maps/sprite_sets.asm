...
MapSpriteSets:
	...
	db SPRITESET_FUCHSIA ; FROST_CAVERN
	db SPRITESET_FUCHSIA ; FROST_DOCK
	db SPRITESET_FUCHSIA ; PALLET_DOCK
	db SPRITESET_SAFFRON ; FROST_SUMMIT
	db SPRITESET_SAFFRON ; FROST_PEAK
