...
ViridianCashierText::
	script_mart POKE_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, LEAF_STONE, TM_FLAMETHROWER
...
CeladonMart2Clerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_DRAININGKISS, TM_METAL_CLAW, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION
