...
DEF SAFARI_ROCK EQU $16 ; overload
	...
	const ELIXER        ; $52
	const MAX_ELIXER    ; $53
	const SINNOH_STONE  ; $54
	const ALOLA_STONE   ; $55
	const GALAR_STONE   ; $56
	const PALDEA_STONE  ; $57
	const TRADE_STONE	; $58
...
DEF TM01 EQU const_value
	...
	add_tm DRAININGKISS ; $CA
	add_tm SWORDS_DANCE ; $CB
	add_tm WHIRLWIND    ; $CC
	add_tm MEGA_KICK    ; $CD
	add_tm TOXIC        ; $CE
	add_tm METAL_CLAW   ; $CF
	add_tm BODY_SLAM    ; $D0
	add_tm TAKE_DOWN    ; $D1
	...
	add_tm FLAMETHROWER ; $FB (Hopefully?)
	add_tm BULLET_SEED  ; $FC
ASSERT NUM_TMS == const_value - TM01, "NUM_TMS ({d:NUM_TMS}) does not match the number of add_tm definitions"

DEF NUM_TM_HM EQU NUM_TMS + NUM_HMS

; 52 TMs + 5 HMs = 57 learnable TM/HM flags per Pokémon.
