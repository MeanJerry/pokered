...
VulpixAPicFront::      INCBIN "gfx/pokemon/front/vulpix_A.pic"
VulpixAPicBack::       INCBIN "gfx/pokemon/back/vulpixb_A.pic"
NinetalesAPicFront::   INCBIN "gfx/pokemon/front/ninetales_A.pic"
NinetalesAPicBack::    INCBIN "gfx/pokemon/back/ninetalesb_A.pic"
